...
htop - program to do something

# SYNOPSIS

**htop** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**htop** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **htop** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**htop** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    htop. See **foo.conf**(5) for further details.
...
**htop** provides some return codes, that can be used in scripts:
...
Matej Kseneman <matej.kseneman@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Matej Kseneman
